...
#     username = forms.CharFiled(widget=forms.TextInput(attrs={"placeholder": "Username", "required": "required"}),
...
#     url = forms.URLField(widget=forms.TextInput(attrs={"placeholders": "url"}),
