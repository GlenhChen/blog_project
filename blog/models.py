...
class User(AbstractUser):
    ...
    # emails = models.EmailField(blank=True, verbose_name='邮箱', unique=True)
    awards = models.CharField(max_length=300, verbose_name='奖项名称')
...
class Article(models.Model):
    ...
    desc = models.CharField(max_length=60, verbose_name='文章描述')
    content = models.TextField(verbose_name='文章内容')
    click_count = models.IntegerField(default=0, verbose_name='点击量')
    is_recommend = models.BooleanField(default=False, verbose_name='是否推荐')
    date_publish = models.DateTimeField(auto_now_add=True, verbose_name='发布时间')
    user = models.ForeignKey(User, verbose_name='用户')
    category = models.ForeignKey(Category, blank=True, null=True, verbose_name='文章')
